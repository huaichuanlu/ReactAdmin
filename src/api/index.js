...
//搜索商品分页列表 searchType是productName/productDesc的值
...
export const reqWeather = (cityCode) => {
  ...
  return new Promise((resolve, reject) => {
    const url = `https://restapi.amap.com/v3/weather/weatherInfo?key=52f0ef4b390b66f0290ffd45b8cb7d07&city=${cityCode}`
    // 发送jsonp请求
    jsonp(url, {}, (err, data) => {
